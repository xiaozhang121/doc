...
<style lang="scss">
	...
	.footer {
		...
		.is_select_icon_0 {
			background: url("../static/tabbar/home_select.png") no-repeat;
		...
		.is_select_icon_1 {
			background: url("../static/tabbar/live_select.png") no-repeat;
			background-size: 100% 100%;
		}
		.un_select_icon_1 {
			background: url("../static/tabbar/live.png") no-repeat;
			background-size: 100% 100%;
		}
		.is_select_text {
			color: #DF1B30;
